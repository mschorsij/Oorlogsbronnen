...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="rdf:RDF">
        ...
        <xsl:if test="edm:ProvidedCHO/dc:type != 'Film'">
            <xsl:if test="contains(su:lowercase(edm:ProvidedCHO/dc:description), 'tweede wereldoorlog')">
    ...
    <xsl:template name="dc_record">
        ...
        <spinque:attribute
            ...
            value="{edm:ProvidedCHO/dcterms:hasFormat}"
            type="string"/>
        ...
        <spinque:attribute
            ...
            value="{edm:ProvidedCHO/dc:identifier}"
            type="string"/>
        <spinque:attribute
            subject="{$subject}"
            attribute="dc:description"
            value="{edm:ProvidedCHO/dc:description}"
            type="string"/>
        ...
        <spinque:relation
            ...
            object="niod:Organizations/13"/>
        <spinque:attribute
            subject="{$subject}"
            attribute="dc:publisher"
            value="Mijn Stad Mijn Dorp"
            type="string"/>
        <!-- end -->
        ...
        <spinque:attribute
            ...
            value="Fotografische Documenten Overijssel"
            type="string"/>
        <spinque:attribute
            subject="{$subject}"
            attribute="schema:disambiguatingDescription"
            value="In Oorlogsbronnen in set beeldbank_hco"
            type="string"/>
        <spinque:attribute
            subject="{$subject}"
